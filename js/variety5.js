// JavaScript Document
    ...
    for (var i = 0; i < items.length; i++) {
        ...
        var rightBox = frame.getElementsByClassName('right')[0];
         // 设置背景图片，从29开始  
		var imageIndex = (i + 29).toString().padStart(2, '0'); 
		frontBox.style.backgroundImage = 'url(image/' + imageIndex + '.jpg)';
		leftBox.style.backgroundImage = 'url(image/' + imageIndex + '.jpg)'; 
		rightBox.style.backgroundImage = 'url(image/' + imageIndex + '.jpg)';  
}
    (function () {
        "use strict";
